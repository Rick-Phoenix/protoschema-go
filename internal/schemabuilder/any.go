...
func ProtoAny(fieldNr uint) *AnyField {
	...
	gf := &AnyField{}
	gf.ProtoFieldExternal = &ProtoFieldExternal[AnyField, any]{&protoFieldInternal{fieldNr: fieldNr, protoType: "google.protobuf.Any", goType: "any", options: options, isNonScalar: true, rules: rules}, gf}
